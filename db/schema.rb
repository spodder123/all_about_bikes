...
ActiveRecord::Schema[7.0].define(version: 2023_07_13_052048) do
  ...
  create_table "prices", force: :cascade do |t|
    t.decimal "price"
    t.integer "city_bike_id", null: false
    t.integer "country_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["city_bike_id"], name: "index_prices_on_city_bike_id"
    t.index ["country_id"], name: "index_prices_on_country_id"
  end

  add_foreign_key "city_bikes", "countries"
  add_foreign_key "prices", "city_bikes"
